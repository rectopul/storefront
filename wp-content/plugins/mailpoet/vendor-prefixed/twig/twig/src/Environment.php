...
class Environment
{
    ...
    public function loadClass($cls, $name, $index = null)
    {
        ...
        if (isset($this->loading[$cls])) {
            throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('Circular reference detected for Twig template "%s", path: %s.', $name, \implode(' -> ', \array_merge($this->loading, [$name]))));
        }
