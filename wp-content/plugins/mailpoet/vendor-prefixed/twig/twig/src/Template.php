...
abstract class Template implements \MailPoetVendor\Twig_TemplateInterface
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = \true)
    {
        ...
        if (null !== $template) {
            try {
                ...
                throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $template->getSourceContext(), $e);
            }
        } elseif (\false !== ($parent = $this->getParent($context))) {
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = [])
    {
        try {
            ...
            throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $this->getSourceContext(), $e);
        }
    }
    /**
